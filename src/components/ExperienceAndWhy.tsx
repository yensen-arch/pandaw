      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-viking-navy mb-4">
            Pandaw and Small Ship Travel - The Perfect Relationship
          </h2>
        ...
        <div className="mb-24">
          <div className="mb-12 flex justify-center border-2 border-viking-gold py-4">
            <img
              src="https://www.smallshiptravel.com/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F6plxhipn%2Fproduction%2F160c432457a92e40a8e9d805ec81af8c24cd908c-1440x452.png%3Fw%3D720&w=750&q=75"
              alt="Pandaw Logo"
